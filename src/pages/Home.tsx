  ...
  return (
    <div>
      <div className="h-screen">
        ...
        <div className='grid grid-cols-2 gap-0 place-items-center mb-40'>
          <img className='object-scale-down h-60 w-60 mb-4' src={process.env.PUBLIC_URL + '/img/camion.png'} />
          <div>
          ...
          <img className='object-scale-down h-60 w-60 mb-4' src={process.env.PUBLIC_URL + '/img/serveur.png'} />
          <img className='object-scale-down h-60 w-60 mb-4' src={process.env.PUBLIC_URL + '/img/travail.png'} />
          <div>
