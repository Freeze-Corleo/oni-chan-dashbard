    ...
    <>
      <div className="w-full h-2/3" style={{ backgroundColor: '#BBF49B' }}>
        <div className="grid grid-cols-1 place-items-center">
          ...
          <img
            className="object-scale-down h-60 w-96 mb-4"
            src={process.env.PUBLIC_URL + '/img/ami.png'}
          />
          <Button label="Partager votre code" onClick={() => {}} />
          <p className="mt-6 font-bold">
            Offrez 10€ et recevez 10€ - Invitez vos amis et c'est nous qui
            régalons !
          </p>
        </div>
      </div>
