...
const DashboardDisplayFastData = () => {
  return (
    <div className="flex justify-between px-20 pt-8 space-x-10">
      ...
      <DashboardCard
        displayedData={'3,287.57 €'}
        title={'Votre revenu hebdomadaire'}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-5 h-5"
      ...
      <DashboardCard displayedData={'7'} title={'Employés qui travaillent'}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-5 h-5"
          fill="none"
      ...
      <DashboardCard displayedData={'128'} title={"Commandes aujourd'hui"}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-5 h-5"
          fill="none"
